...
const Index = () => {
  ...
  return <div className="min-h-screen flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat" style={{
    ...
    backgroundPosition: 'center'
      ...
      <div className="text-center max-w-3xl px-6 py-12 rounded-xl backdrop-blur-sm bg-transparent">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 text-white font-display"></h1>
        <p className="text-xl md:text-2xl text-white mb-8">
          Create magical, personalized books for children with AI-generated images and stories.
        </p>
        
        <div className="space-y-4">
          <Button size="lg" className="w-full md:w-auto px-8 bg-amber-500 hover:bg-amber-600 text-white font-semibold text-lg" onClick={() => navigate('/books')}>
            Start Your Journey
          </Button>
