  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-indigo-100">
      <div className="text-center max-w-3xl px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-indigo-700">Children's Book Generator</h1>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-500 mt-4">
            Create personalized children's books with beautiful illustrations generated by AI.
            Save, share, and export your creations as professional-quality PDFs.
          </p>
        </div>
      </div>
    </div>
