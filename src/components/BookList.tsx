  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={onCreateBook} className="bg-primary hover:bg-primary/90 flex items-center">
      ...
      {books.length === 0 ? (
        <div className="text-center py-12">
          ...
          <Button onClick={onCreateBook} className="bg-primary hover:bg-primary/90">
            <Plus className="w-5 h-5 mr-2" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <div className="aspect-[3/4] flex items-center justify-center rounded-xl border-2 border-dashed border-gray-300 hover:border-primary transition-colors">
            ...
            >
              ...
              <span className="text-gray-600">New Book</span>
            </Button>
          </div>
        </div>
      )}
