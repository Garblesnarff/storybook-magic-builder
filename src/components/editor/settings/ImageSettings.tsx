...
export const ImageSettings: React.FC<ImageSettingsProps> = ({
  ...
  return <div className="space-y-4">
      ...
      <div className="pt-4">
        ...
        <p className="text-xs text-gray-500 mt-2">This will generate an image based on the current page text using Google's Gemini 2.0 model. More fine tuned image generation coming in the future.</p>
      </div>
      
      {currentPageData.image && <div className="pt-2">
          <Label>Current Image</Label>
          <div className="mt-2 border rounded-md overflow-hidden bg-gray-50">
            <img src={currentPageData.image} alt="Generated illustration" className="w-full h-auto" />
          </div>
        </div>}
    </div>;
};